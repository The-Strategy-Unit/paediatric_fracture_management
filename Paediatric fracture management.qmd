...
Total fracture incidence rate {style="text-align: center;"}
```{r, fig.height=8}
#| crop: true
...
The percentage of forearm, elbow and tibia/fibula fractures manipulated in the Emergency Department have all decreased over the last 6 yrs. 

There the decrease in percentage of forearm fractures manipulated in the emergency department is particularly large and there is also a noticeable seasonal trend with more fractures manipulated in the emergency department during the summer months.
:::
:::
...
The percentage of forearm fractures manipulated in theatre has increased over the last 6 yrs. 
:::
...
Despite an increase in the percentage of forearm fractures manipulated in theatre over the last 6 years the proportion of manipulations in theatre compared to the emergency department has decreased. This is due to a significant decrease in manipulations in the emergency department/total number of manipulations.  
:::

#### Total number of manipulations (theatre & ED)
::: {.column width="39%"}
```{r, fig.height=6, fig.width=7}
...
plots_of_proportion_by_trust(manipulations_by_trust|>filter(mua=="Manipulation in theatre"), "Elbow", "% of elbow fractures  manipulated in theatre", 5)
...
girft_metric<-paed_fractures|>
  filter(der_financial_year=="2018/19" & mua=="Manipulation in theatre", type=="Forearm")|>
