...
::: small
If all trusts reduced the percentage of follow-ups to the level of the lowest decile of trusts (`r calculating_lowest_10percent( "Forearm")`%) there would be an **annual reduction in England of `r format(calculating_saving_f_up("Forearm"), big.mark=",")`** (`r calculating_percentage_change_f_up( "Forearm")`%) follow-up appointments.
:::
:::
...
::: small
If all trusts reduced the percentage of follow-ups to the level of the lowest decile of trusts (`r calculating_lowest_10percent( "Elbow")`%) there would be an **annual reduction in England of `r format(calculating_saving_f_up("Elbow"), big.mark=",")`** (`r calculating_percentage_change_f_up( "Elbow")`%) follow-up appointments.
:::
:::
...
::: small
If all trusts reduced the percentage of follow-ups to the level of the lowest decile of trusts (`r calculating_lowest_10percent( "Clavicle")`%) there would be an **annual reduction in England of `r format(calculating_saving_f_up("Clavicle"), big.mark=",")`** (`r calculating_percentage_change_f_up( "Clavicle")`%) follow-up appointments.
:::
:::
:::
...
::: small
If all trusts reduced the percentage of follow-ups to the level of the lowest decile of trusts (`r calculating_lowest_10percent("Toe")`%) there would be an **annual reduction in England of `r format(calculating_saving_f_up("Toe"), big.mark=",")`** (`r calculating_percentage_change_f_up("Toe")`%) follow-up appointments.
:::
:::

::: {.column width="33%"}
```{r}
total_f_up_saving<-(calculating_saving_f_up("Forearm")+ 
                   calculating_saving_f_up("Elbow")+
                   calculating_saving_f_up("Clavicle")+
                   calculating_saving_f_up("Tibia/Fibula")+
                   calculating_saving_f_up("Toe") ) 
...
::: {.column width="50%"}
::: {small}
There could be an **annual reduction in England of `r calculating_saving( "Tibia/Fibula")`** (`r calculating_percentage_change( "Tibia/Fibula")`%) manipulations in theatre, if all trusts reduced their percentage to the level of the lowest quartile (`r calculating_lowest_quartile("Tibia/Fibula")`%). This size of reduction is unlikely to have a significant impact in freeing up theatre time.
:::
:::
:::
...
## Appendix A- Wrist and Forearm fracture SNOMED codes

```{r}
fracture_codes<-read.csv("Data/Snomed fracture codes for NCDR.csv")|>
...
snomed_code_tables(a, "Wrist/Forearm", 8, 0.8)
```
:::
...
snomed_code_tables(b, "Wrist/Forearm", 8, 0.8)
```
...
snomed_code_tables(c, "Wrist/Forearm", 8, 0.8)
```
:::
:::
...
::: smaller
Main Specialty was either:

-  110 Trauma and Orthopaedics
-  171 Paediatric surgery

AND the Treatment function code was one of:
...
If both the Main Specialty and the Treatment Function Code were 420 Paediatrics/Paediatric Service the record was only included if the outpatient referral source was either: 10- initiated following an Emergency Care Attendance (including Minor Injuries, Walk In Centres and Urgent Treatment Centres) OR 04- not initiated following a referral from an Emergency Care Department (including Minor Injuries Units, Walk In Centres and Urgent Treatment Centres)
