...
manitest<-proportion_mua_in_theatre_vs_ED|>
  filter(type=="Forearm" & mua=="Manipulation in theatre")|>
  rename(Percentage_mua=Percentage)

edtest<-ed_vs_utc|>
  filter(type=="Forearm" & (mua=="Manipulation in theatre"| mua=="Manipulation in ED"))|>
...
edtest|>
  ...
  labs(x="Percentage using UTCs", y="Percentage of manipulations in theatre")
