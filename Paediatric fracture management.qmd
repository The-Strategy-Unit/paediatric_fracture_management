...
```
:::
These proportions are slightly lower than seen in the GIRFT study. It is not clear exactly which fracture types and which manipulations were included within that study.

We have excluded open fractures and only included manipulations without internal or external fixation, which may explain the discrepancy in the results.
:::
...
#### Manipulation in emergency department
A&E treatment code: 10- Reduction 
