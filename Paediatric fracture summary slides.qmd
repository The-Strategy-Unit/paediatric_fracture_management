...
management of paediatric fractures and potential for an new mitigator in the NHP model.
...
## Incidence rate {.section_header background-color="#0087bd"}
...
:::
## Most common fracture types (2023/2024) {background-image="slide.png" background-size="contain" visibility="hidden"}
...
## Trends in paediatric fracture management {.section_header background-color="#0087bd"}
